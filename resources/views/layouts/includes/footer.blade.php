<div id="Site-Footer" class="footer-area">
  <div class="container">
    ...
    <section class="articles-and-advices pt-28">
      ...
      <div class="section-content flex justify-between -mx-4">
        <div class="single-block flex-1 px-4">
    ...
    <section class="additional-services pt-28">
      ...
      <div class="section-content flex justify-between text-lg -mx-4">
        <div class="single-block px-4">
    ...
    <section class="site-footer mt-24 py-8 border-t-2 border-gray-400">
      <div class="flex -mx-4">
        ...
        <div class="footer-nav flex-1 px-4">
