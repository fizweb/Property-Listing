      ...
      <div class="w-9/12 mx-2">
        ...
        <div class="flex justify-between items-center bg-white p-8 mt-10 shadow-sm">
          ...
          <div class="border-l-2 border-gray-300 pl-5 ml-5 w-10/12 text-base">
            <p>Beachfront suites located at the starting point of the Blue Voyage in Bodrum, these sea view properties are designed and operated in partnership with a worldwide hotel chain and feature outstanding on-site facilities for 5-star luxury living guaranteed – anyone who purchases here can rest assured that these are the very best in fully-managed and fully-serviced residences in all of Turkey.</p>
          </div>
        </div>
        ...
        <div class="bg-white p-8 mt-10 shadow-sm" id="description">
          ...
          <p>With beautiful views across the sea and bay, these stunning properties are luxury-designed and tick all the boxes for those looking for an elite lifestyle in an exclusive development in a highly sought after area of Bodrum, within driving distance to the city centre and with sailing options, restaurants, private pools, and a plethora of other features available.</p>

          <h3 class="mb-2">About the project and residences</h3>
          <p>There are luxury suites for sale, designed with exclusive and outstanding architecture with attention to detail in every corner. There are different floor plans available, with residences ranging in size for all types of buyers. Buyers can choose from duplex properties or penthouse homes. Garden floor duplex residences and all penthouses have their own private swimming pools attached for added comfort and a luxury lifestyle guaranteed.</p>
          <p>By owning a property within this development, you are entitled access to outstanding, world class on-site social and communal facilities run in partnership with a worldwide award-winning hotel brand, including everything from maintenance to housekeeping to sea shuttle services taking you to Bodrum Marina – life here is a 5-star resort on a daily basis and all just a phone call away; the developer has included and thought of everything.</p>
          <p>Inside, each suite has been fully furnished and decorated from top to bottom, leaving you with only the difficult task left of packing your suitcase to head for Bodrum as absolutely everything else is ready and waiting for you. All properties are fitted with the latest technologies and mod cons to provide a luxury lifestyle at home. Floor space has been perfectly planned inside and out to take advantage of full open sea and bay views throughout. Garden floor duplexes and penthouse suites have private swimming pools.</p>
          ...
          <p>The project is split into two sections – luxury residences and valley residences, all situated in one of the most stunning bays in Yaliciftlik. Property prices and availability range from the following:&nbsp;</p>
          <p>- 42 residences from three – seven bedrooms and sized 327m2 – 675m2 for sale from 1,750,000 Euro.&nbsp;</p>

          <p><strong>NOTE</strong>: Prices displayed exclude VAT.</p>
          
          <p><strong>Rental potential</strong></p>
          <p>Should you desire to rent your suite out when not in use or are an investor looking for high end opportunities in Bodrum, there is a dedicated rental team on site happy to assist you and rent your property out on your behalf.</p>
