...
<div class="welcome-page-wrapper">
  <div class="hero-area relative bg-cover bg-center pt-40 pb-48 z-10" style="background-image: url('{{ asset('assets/img/bg/hero-bg-1.jpg') }}')">
    ...
    <div class="content container relative text-white text-xl md:text-2xl text-center z-20">
      <h2 class="text-4xl md:text-6xl leading-tight mb-8">Lorem ipsum dolor sit amet, <br/>consectetur adipisicing necessitatibus.</h2>
  ...
  <div class="welcome-page-center text-center pt-32">
    <div class="container">
      ...
      <div class="block pt-28">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 -mx-5 px-10">
          @for ( $x = 1; $x <= 6; $x++ )
            <div class="px-5 mb-8">
              <div class="mx-8">
      ...
      <div class="block pt-28">
        ...
        <div class="video-wrapper mb-16">
          ...
          <a data-lity class="video-play relative block w-full h-80 bg-cover bg-center text-white text-center leading-loose rounded-xl" 
          href="https://www.youtube.com/watch?v=fd8a-8ujfyc?autoplay=1" 
          style="background-image: url(https://img.youtube.com/vi/fd8a-8ujfyc/maxresdefault.jpg);">
          ...
          <div class="overlay absolute w-full h-full left-0 top-0 bg-black rounded-xl opacity-50 z-10"></div>
            <div class="table w-full h-full relative z-20">
              <div class="table-cell h-full align-middle">
                <span class="icon w-32 h-32 text-center leading-loose pl-1 pt-2 text-5xl">
                  {{-- <i class="fa fa-play"></i> --}}
                  <i class="w-full h-full" data-feather="play-circle"></i>
                </span>
        ...
        <div class="text-2xl leading-normal">
          ...
          <div class="flex flex-wrap my-14 -mx-8 px-20">
            <div class="flex-1 w-1/2 md:w-auto mb-8 md:mb-0 px-8">
              <div class="mb-3">
        ...
        <div class="flex flex-col md:flex-row -mx-10 mb-20">
          <div class="flex-1 pb-8 md:pb-0 pt-5 px-10 md:pr-16 text-2xl text-center md:text-left leading-normal">
            <p class="text mb-8">
          ...
          <div class="flex-1 px-10">
            <div class="relative w-full h-52 md:h-full mb-8 md:mb-0 mx-10 md:mx-0">
              <span class="absolute w-1/2 md:w-3/5 h-full md:h-80 -left-2 top-7 md:top-auto md:-bottom-2 bg-transparent border-2 border-gray-500 rounded-tl-lg rounded-br-lg rounded-bl-100 rounded-tr-100 z-10">
              </span>
              <span class="absolute w-1/2 md:w-3/5 h-full md:h-80 left-0 top-6 md:top-auto md:bottom-0 bg-cover bg-center rounded-tl-lg rounded-br-lg rounded-bl-100 rounded-tr-100 z-20"
              style="background-image: url('{{ asset('assets/img/bg/sample-img.jpg') }}')">
              </span>

              <span class="absolute w-1/2 md:w-3/5 h-full md:h-80 right-14 md:-right-10 top-0 bg-cover bg-center rounded-tl-lg rounded-br-lg rounded-bl-100 rounded-tr-100 transform rotate-6 z-10"
              style="background-image: url('{{ asset('assets/img/bg/sample-img.jpg') }}')">
              </span>
            </div>
          </div>
        ...
        <div class="flex flex-col md:flex-row justify-center items-center">
          ...
          <span class="block md:inline-block text-4xl font-bold my-5 md:my-0 px-14">or</span>
          ...
          @if ( $properties )
            <div class="section-content flex flex-wrap -mx-2">
              @foreach ( $properties as $property )
                @include('components.property.single-property-card', [ 'property' => $property, 'width' => 'w-full md:w-1/4', ])
              @endforeach
            </div>
          @endif
